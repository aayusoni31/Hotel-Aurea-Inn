      ...
      return (
        ...
        this.each(function () {
          ...
          if (h.CSSAIsRunning && h.eventType == j.type)
            ...
            ((h.CSSqueue = null), (h.eventType = j.type), 0 !== i.length && a)
          ) {
            if (
              ((h.CSSAIsRunning = !0),
              "function" == typeof b &&
            ...
            if (
              ...
              jQuery.browser.webkit
                ? ((l = "-webkit-"), (m = "webkitTransitionEnd"))
                : jQuery.browser.mozilla
                ? ((l = "-moz-"), (m = "transitionend"))
                : jQuery.browser.opera
                ? ((l = "-o-"), (m = "otransitionend"))
                : jQuery.browser.msie &&
                  ((l = "-ms-"), (m = "msTransitionEnd")),
                (j = []);
              for (n in a)
                (k = n),
                  "transform" === k &&
                    ((k = l + "transform"), (a[k] = a[n]), delete a[n]),
                  "filter" === k &&
                    ((k = l + "filter"), (a[k] = a[n]), delete a[n]),
                  ("transform-origin" === k || "origin" === k) &&
                    ((k = l + "transform-origin"), (a[k] = a[n]), delete a[n]),
                  "x" === k &&
                    ((k = l + "transform"),
                    (a[k] = a[k] || ""),
                    (a[k] += " translateX(" + g(a[n], "px") + ")"),
                    delete a[n]),
                  "y" === k &&
                    ((k = l + "transform"),
                    (a[k] = a[k] || ""),
                    (a[k] += " translateY(" + g(a[n], "px") + ")"),
                    delete a[n]),
                  "z" === k &&
                    ((k = l + "transform"),
                    (a[k] = a[k] || ""),
                    (a[k] += " translateZ(" + g(a[n], "px") + ")"),
                    delete a[n]),
                  "rotate" === k &&
                    ((k = l + "transform"),
                    (a[k] = a[k] || ""),
                    (a[k] += " rotate(" + g(a[n], "deg") + ")"),
                    delete a[n]),
                  "rotateX" === k &&
                    ((k = l + "transform"),
                    (a[k] = a[k] || ""),
                    (a[k] += " rotateX(" + g(a[n], "deg") + ")"),
                    delete a[n]),
                  "rotateY" === k &&
                    ((k = l + "transform"),
                    (a[k] = a[k] || ""),
                    (a[k] += " rotateY(" + g(a[n], "deg") + ")"),
                    delete a[n]),
                  "rotateZ" === k &&
                    ((k = l + "transform"),
                    (a[k] = a[k] || ""),
                    (a[k] += " rotateZ(" + g(a[n], "deg") + ")"),
                    delete a[n]),
                  "scale" === k &&
                    ((k = l + "transform"),
                    (a[k] = a[k] || ""),
              ...
              var n = j.join(","),
                o = function () {
                  i.off(m + "." + h.id),
                    ...
                    (h.called = !0),
                    (h.CSSAIsRunning = !1),
                    "function" == typeof h.CSSqueue &&
                      (h.CSSqueue(), (h.CSSqueue = null));
                },
                p = {};
              jQuery.extend(p, a),
                (p[l + "transition-property"] = n),
                (p[l + "transition-duration"] = b + "ms"),
                (p[l + "transition-delay"] = c + "ms"),
                (p[l + "transition-style"] = "preserve-3d"),
                (p[l + "transition-timing-function"] = d),
                setTimeout(function () {
                  i.one(m + "." + h.id, o), i.css(p);
                }, 1),
                (h.timeout = setTimeout(function () {
                  i.called || !e
                    ? ((i.called = !1), (h.CSSAIsRunning = !1))
                    : (i.css(l + "transition", ""),
                      e(i),
                      (h.CSSAIsRunning = !1),
                      "function" == typeof h.CSSqueue &&
              ...
              for (var n in a)
                "transform" === n && delete a[n],
                  "filter" === n && delete a[n],
                  "transform-origin" === n && delete a[n],
                  "auto" === a[n] && delete a[n];
  ...
  (jQuery.mbYTPlayer = {
    ...
    buildPlayer: function (options) {
      return this.each(function () {
        ...
        v.canPlayType && jQuery.extend(playerVars, { html5: 1 }),
          jQuery.browser.msie &&
        ...
        if (
          ...
          jQuery(document).on("YTAPIReady", function () {
            (YTPlayer.isBackground && ytp.backgroundIsInited) ||
              YTPlayer.isInit ||
              (YTPlayer.isBackground &&
                YTPlayer.opt.stopMovieOnClick &&
                jQuery(document)
                  .off("mousedown.ytplayer")
                  .on("mousedown.ytplayer", function (a) {
                                  ...
                                  (YTPlayer.checkForStartAt = setInterval(
                                    function () {
                                      var a =
                                        ...
                                        b / YTPlayer.player.getDuration();
                                      YTPlayer.player.getDuration() > 0 &&
                                      YTPlayer.player.getCurrentTime() >= b &&
                                      a
                                        ? (clearInterval(
                                    ...
                                    case 1:
                                      (eventType = "YTPStart"),
                                        controls
                                          ...
                                          .html(
                                            jQuery.mbYTPlayer.controls.pause
                                          ),
    ...
    getDataFromFeed: function (a) {
      jQuery.browser.msie && jQuery.browser.version <= 9
        ? ("auto" == a.opt.ratio ? (a.opt.ratio = "16/9") : a.opt.ratio,
          a.hasData ||
            ((a.hasData = !0),
            setTimeout(function () {
        ...
        : (jQuery.getJSON(
            ...
            function (b) {
              ...
              if (
                (jQuery(a).trigger(e),
                (a.videoTitle = a.videoData.title),
                "auto" == a.opt.ratio &&
                  (a.opt.ratio =
          ...
          setTimeout(function () {
            a.dataReceived ||
              a.hasData ||
              ((a.hasData = !0), jQuery(a).trigger("YTPChanged"));
          }, 1500));
    },
    ...
    YTPlaylist: function (a, b, c) {
      ...
      (d.isPlayList = !0),
        ...
        d.videoID ||
          ((d.videos = a),
          (d.videoCounter = 0),
          (d.videoLength = a.length),
          jQuery(d).data("property", a[0]),
          jQuery(d).mb_YTPlayer()),
        "function" == typeof c &&
          jQuery(d).on("YTPChanged", function () {
            c(d);
          }),
    ...
    playNext: function () {
      ...
      a.videoCounter++,
        ...
        jQuery(a.playerEl).css({ opacity: 0 }),
      ...
      jQuery(b.playerEl).CSSAnimate({ opacity: 0 }, c),
        setTimeout(function () {
          ...
          jQuery(b)
            ...
            jQuery(b).playYTP(),
            jQuery(b).one("YTPStart", function () {
              b.wrapper.CSSAnimate(
                { opacity: b.isAlone ? 1 : b.opt.opacity },
                1e3
              ),
                jQuery(b.playerEl).CSSAnimate({ opacity: 1 }, c),
                b.opt.startAt && b.player.seekTo(b.opt.startAt),
        ...
        b.opt.addRaster
          ? b.overlay.addClass(b.isRetina ? "raster retina" : "raster")
          : b.overlay.removeClass("raster").removeClass("retina"),
        jQuery("#controlBar_" + b.id).remove(),
        b.opt.showControls && jQuery(b).buildYTPControls(),
        jQuery.mbYTPlayer.getDataFromFeed(b),
    ...
    setYTPVolume: function (a) {
      ...
      a || b.opt.vol || 0 != b.player.getVolume()
        ? (!a && b.player.getVolume() > 0) || (a && b.player.getVolume() == a)
          ? jQuery(b).muteYTPVolume()
          : (b.opt.vol = a)
        : jQuery(b).unmuteYTP(),
        ...
        (YTPlayer.getState = setInterval(function () {
          ...
          if (
            ...
            eval(YTPlayer.opt.stopMovieOnBlur) &&
              (document.hasFocus()
                ? document.hasFocus() &&
                  ...
                  -1 != YTPlayer.state &&
                  0 != YTPlayer.state &&
                  ((YTPlayer.hasFocus = !0), $YTPlayer.playYTP())
                : 1 == YTPlayer.state &&
            ...
            data.loop
              ...
              : (YTPlayer.player.pauseVideo(),
                YTPlayer.wrapper.CSSAnimate({ opacity: 0 }, 1e3, function () {
