...
$(document).ready(function () {
  ...
  $(".modal-container").each(function (index) {
    ...
    $(this)
      ...
      .prepend($('<i class="ti-close close-modal">'));
  });

  $(".btn-modal").click(function () {
    var linkedModal = $("section")
      .closest("body")
      .find('.foundry_modal[modal-link="' + $(this).attr("modal-link") + '"]');
    $(".modal-screen").toggleClass("reveal-modal");
    if (linkedModal.find("iframe").length) {
      linkedModal
        .find("iframe")
        .attr("src", linkedModal.find("iframe").attr("data-src"));
    }
  ...
  $(".modal-video-container .play-button").click(function () {
    var linkedVideo = $("section")
      .closest("body")
      .find('.modal-video[video-link="' + $(this).attr("video-link") + '"]');
