    ...
    callback: function (e) {
      ...
      if (v)
        for (c = c.getElementsByClassName("tweet"); d < c.length; ) {
          0 < c[d].getElementsByClassName("retweet-credit").length
            ? a.push(!0)
            : a.push(!1);
          if (!a[d] || (a[d] && z))
        ...
        for (c = p(c, "tweet"); d < c.length; )
          e.push(p(c[d], "e-entry-title")[0]),
            ...
            d++;
      e.length > l &&
        (e.splice(l, e.length - l),
        g.splice(l, g.length - l),
        f.splice(l, f.length - l),
      ...
      for (a = 0; a < d; ) {
        ...
        b = "";
        s
          ? (r && (b += '<div class="user">' + x(g[a].innerHTML) + "</div>"),
            ...
            q &&
              (b +=
                ...
                "</p>"))
          : e[a].innerText
          ? (r && (b += '<p class="user">' + g[a].innerText + "</p>"),
            (b += '<p class="tweet">' + e[a].innerText + "</p>"),
            q && (b += '<p class="timePosted">' + f[a].innerText + "</p>"))
          : (r && (b += '<p class="user">' + g[a].textContent + "</p>"),
            (b += '<p class="tweet">' + e[a].textContent + "</p>"),
            q && (b += '<p class="timePosted">' + f[a].textContent + "</p>"));
        A &&
          (b +=
